...
public class CustomerAgent extends UntypedActor {
	...
	public void onReceive(Object msg) throws Exception {
		...
		if(msg instanceof ReservationStatusCode){
			...
			if(code == ReservationStatusCode.STATUS_AWAITING_PAIMENT){
				...
				terminationListener.tell(DONE, getSelf());//as extra feature a customer could say: hey
	...
	public String randomSectionSelector(){
		...
		switch(result){
		case 1: return Section.FLOOR; 
		case 2: return Section.FIRST_RING_NORTH; 
		case 3: return Section.FIRST_RING_SOUTH; 
		case 4: return Section.FIRST_RING_WEST; 
		case 5: return Section.SECOND_RING_NORTH; 
		case 6: return Section.SECOND_RING_SOUTH; 
		case 7: return Section.SECOND_RING_WEST;
		default: assert false: "error uknown section number was generated"; return null;
		}
	}
	/**
